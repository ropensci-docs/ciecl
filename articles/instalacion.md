...
`pak::pak("ropensci/ciecl")` para empezar.
...
|----|----|----|
| Índices de comorbilidad Charlson/Elixhauser con [`cie_comorbid()`](https://docs.ropensci.org/ciecl/reference/cie_comorbid.md) | `comorbidity` | `install.packages("comorbidity")` |
| Tablas HTML formateadas con [`cie_table()`](https://docs.ropensci.org/ciecl/reference/cie_table.md) | `gt` | `install.packages("gt")` |
...
> `ICD_API_KEY`, configurada con
> [`usethis::edit_r_environ()`](https://usethis.r-lib.org/reference/edit.html)
> (Opción B) o vía `keyring` (Opción A). El argumento `api_key` de
> [`cie11_search()`](https://docs.ropensci.org/ciecl/reference/cie11_search.md)

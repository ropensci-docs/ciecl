...
GitHub](https://github.com/ropensci/ciecl/issues) con:
...
Conducta de rOpenSci](https://ropensci.org/code-of-conduct/).

## Preguntas

Para preguntas generales, abre un
[issue](https://github.com/ropensci/ciecl/issues) usando la plantilla
...
GitHub](https://github.com/ropensci/ciecl/issues) with:
...
By participating in this project, you agree to abide by the [rOpenSci
Code of Conduct](https://ropensci.org/code-of-conduct/).

## Questions

For general questions, open an
[issue](https://github.com/ropensci/ciecl/issues) using the **Question**
template, which applies the `question` label automatically.
